...
if( isset($_POST['name']) && isset($_POST['email']) && isset($_POST['msg']) && isset($_POST['phone']) && isset($_POST['address']) ){
    ...
    if (MAIL_TITLE != null) {
        ...
        $subject = '[Lyrae] Contact Form Message';

    }

    $message = '<b>Name:</b> '.$name.' <br><b>Email:</b> '.$email.' <br> <b>Phone:</b> '.$phone.' <br><b>Address:</b> '.$address.'<p>'.$msg.'</p>';
